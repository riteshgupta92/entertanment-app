      ...
      <div className="w-full max-w-[1000px] h-auto gap-8 bg-transparent grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 p-5 rounded-md shadow-sm shadow-blue-100">
        ...
        <div className="p-2">
          ...
          <p className="text-md mb-4">
            <strong className="text-[#a9aebb]">Release Date:</strong> {new Date(movieDetails.release_date).toLocaleDateString()}
          </p>
          <p className="text-md mb-4">
            <strong className="text-[#a9aebb]">Rating:</strong> {movieDetails.vote_average}
            <span className="mx-2">⭐️⭐️⭐️⭐️☆</span><span> ({movieDetails.vote_count} votes)</span>
          </p>
          <p className="text-md mb-4">
            <strong className="text-[#a9aebb]">Movie Length:</strong> {runtime} minutes
          </p>
          <p className="text-md mb-4">
            <strong className="text-[#a9aebb]">Language:</strong> <span> {movieDetails.original_language}</span>
          </p>
          <p className="text-md mb-4">
